...
lib.define("sm80_attn_int8(Tensor Q, Tensor K, Tensor V, Tensor scale_Q, Tensor scale_K, Tensor scale_V) -> Tensor")
...
@torch.library.impl(lib, "sm80_attn_int8", "Meta")
